...
* `ALLOW_IPS`: The subnet masks or IP addresses of the terminal that is allowed to attend
* `DENY_IPS`: The subnet masks or IP addresses of the terminal that is denied to attend
